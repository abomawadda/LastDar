...
export default function StudentStats({ stats }) {
  return (
    <section className="grid grid-cols-2 gap-3 xl:grid-cols-4">
      <StatCard title="إجمالي الطلاب" value={stats.total} note="كل السجلات" icon={Users} />
      <StatCard title="الطلاب الذكور" value={stats.male} note="عدد الذكور" icon={Users} />
      <StatCard title="الطالبات" value={stats.female} note="عدد الإناث" icon={GraduationCap} />
      <StatCard title="النشطون" value={stats.active} note="حالة فعالة" icon={ShieldCheck} />
    </section>
  );
}
